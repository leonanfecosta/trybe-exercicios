...
const searchEmployee = (id, detail) => {
  ...
  if (!employee) {// retorna true se a condição do for não for atendida quando o id não existir ou estiver vazio
    throw new Error("ID não identificada");
  }

  if (!employee[detail]) {//retorna true quando os parametros são passados incorretamente
