...
// Ocorre devido a clase tech que, originalmente, está aplicada apenas a primera caixa com uma propriedade do css aplicada
...
function myWebpageReplace(event) {
  window.location.replace("https://leonanfecosta.github.io/");
}
myWebpage.addEventListener("dblclick", myWebpageReplace);

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;
function mouseOver(event) {
  event.target.style.color = "rgb(0, 255, 0)";
}
