...
class Contact extends React.Component {
  static validateField(field, value) {
    switch (field) {
    case 'name':
      return Contact.validatePresence('Nome', value);
    case 'message':
      return Contact.validatePresence('Mensagem de contato', value);
    case 'email': {
  ...
  validateForm() {
    ...
    Object.keys(state.formErrors).forEach((field) => {
      const errorMessage = Contact.validateField(field, state[field]);
